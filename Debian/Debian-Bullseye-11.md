...
3. 配置软件包源：
   ...
   ```ini
   deb http://deb.debian.org/debian bullseye main contrib non-free-firmware
   deb-src http://deb.debian.org/debian bullseye main contrib non-free-firmware

   deb http://deb.debian.org/debian-security bullseye-security main contrib non-free-firmware
   deb-src http://deb.debian.org/debian-security bullseye-security main contrib non-free-firmware

   deb http://deb.debian.org/debian bullseye-updates main contrib non-free-firmware
   deb-src http://deb.debian.org/debian bullseye-updates main contrib non-free-firmware
   ```
