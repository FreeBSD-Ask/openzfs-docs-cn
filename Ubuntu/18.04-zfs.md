...
如果你遇到与本教程相关的 bug 或功能请求，请 [创建新 issue 并提及 @rlaager](https://github.com/openzfs/openzfs-docs/issues/new?body=@rlaager,%20I%20have%20the%20following%20issue%20with%20the%20Ubuntu%2018.04%20Root%20on%20ZFS%20HOWTO:)。
...
* 池名称可自定义，但如果修改，必须在整个配置中保持一致。本教程中使用 `bpool` 作为约定名称。
